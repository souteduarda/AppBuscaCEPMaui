...
namespace AppBuscaCEPMaui.Services
{
    public class DataServices
    {
        ...
        public static async Task<List<Logradouro>> GetLogradourosByBairroIdCidade (string bairro, int id_cidade)
        {
        ...
        public static async Task<List<Cep>> GetCepsByLogragouro(string logradouro)
        {
